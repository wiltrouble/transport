...
export const NOTIFICATION_PARENT_COL =
  process.env.NEXT_PUBLIC_APPWRITE_N_PARENT_REL?.trim() || "parentId";
export const NOTIFICATION_STUDENT_COL =
  process.env.NEXT_PUBLIC_APPWRITE_N_STUDENT_REL?.trim() || "studentId";
export const NOTIFICATION_SESSION_COL =
  process.env.NEXT_PUBLIC_APPWRITE_N_SESSION_REL?.trim() || "transportSessionId";
